      ...
      <section className="py-8 md:py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6 md:mb-12">
            <h2 className="font-heading font-bold text-2xl md:text-3xl lg:text-4xl mb-2">Safra Atual</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-lg shadow-md overflow-hidden p-4 md:p-6 animate-pulse">
                <div className="h-48 md:h-56 lg:h-64 bg-gray-300 mb-4"></div>
                <div className="h-5 md:h-6 bg-gray-300 w-3/4 mb-2"></div>
                <div className="h-3 md:h-4 bg-gray-300 w-full mb-4"></div>
                <div className="h-8 md:h-10 bg-gray-300 w-full"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="p-4 md:p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-heading font-bold text-lg md:text-xl">{product.name}</h3>
                ...
                <p className="text-gray-600 mb-3 md:mb-4 text-xs md:text-sm mobile-text-fix">{product.shortDescription}</p>
                <div className="flex flex-wrap gap-1.5 md:gap-2 mb-3 md:mb-4">
                  {product.moisture && (
                    <span className="bg-gray-200 text-gray-600 text-xs px-2 py-0.5 md:py-1 rounded-full">
        ...
        <div className="text-center mt-8 md:mt-12">
          <Link href="/produtos">
            <Button 
              variant="outline" 
              className="border-primary text-primary hover:bg-primary hover:text-white font-heading font-semibold text-sm md:text-base px-4 py-2 md:px-6 md:py-3 h-auto"
            >
